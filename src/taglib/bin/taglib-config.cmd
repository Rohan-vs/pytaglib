...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Users/rsuri/Downloads/taglib/taglib-install/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Users/rsuri/Downloads/taglib/taglib-install/include/taglib
if /i "%1#" == "--version#" echo 1.11.1
if /i "%1#" == "--prefix#"  echo C:/Users/rsuri/Downloads/taglib/taglib-install
